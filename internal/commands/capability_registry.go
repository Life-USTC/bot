...
func init() {
	capabilityDescriptors = []CapabilityDescriptor{
		...
		}, busPolicy, helpMeta("bus", "校车", "查询班次、路线与设置偏好", true, []HelpExample{example("校车", "查看接下来各路线的校车"), example("校车 查询 东区 西区", "查询指定路线"), example("校车 偏好", "查看校车偏好"), example("校车 偏好 路线 东区 西区", "设置偏好路线")}, []HelpExample{example("校车（xc）", "直接查询接下来的校车")})),
